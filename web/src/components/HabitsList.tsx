    ...
    return (
        ...
        <div className='mt-6 flex flex-col gap-3'>
            {habitsInfo?.possibleHabits.map(habit => {
                ...
                group-data-[state=checked]:bg-green-500 transition.colors group-focus:ring-2 group-focus:ring-violet-600 group-focus:ring-offset-2 group-focus:ring-offset-zinc-900'>
                            <Checkbox.Indicator >
