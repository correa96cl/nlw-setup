...
import { generateProgressPercentage } from "../utils/generate-progress-percents";
...
export function Habit() {
    ...
    async function fetchHabits() {
        try {
            ...
            console.log(error);
            Alert.alert('Ops', 'Não foi possivel carregar as informações do hábitos');
        } finally {
            setLoading(false);
        }
    }
                ...
                </View>
                {
                    isDateInPast && (
                        <Text className="text-white mt-10 text-center">
                            Você nāo pode editar habitos de uma data passada.
                        </Text>
                    )
                }
            </ScrollView>
